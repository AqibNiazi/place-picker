...
// Get the user's current location and sort the available places by distance
...
function App() {
  ...
  // and when the user's location changes
  // This will ensure that the available places are always sorted by distance
